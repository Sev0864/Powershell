...
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=Table" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $TablesFolder -Force
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=Page" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $PagesFolder -Force
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=Report" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $ReportsFolder -Force
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=Codeunit" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $CodeunitsFolder -Force
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=Query" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $QUeriesFolder -Force
Export-NAVApplicationObject $GitFolderWorkingObjectTextFile -DatabaseName $Database -Filter "Type=XMLPort" -ExportTxtSkipUnlicensed -force | Split-NAVApplicationObjectFile -Destination $XMLPortFolder -Force
